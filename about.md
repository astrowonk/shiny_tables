...
This `enhanced_from_dataframe` function creates bootstrap tables with some automatic features like links and conditional formatting. [Find the source on Github](https://github.com/astrowonk/shiny_tables).
